...
const CityCanvas = lazy(() => import("./consumer/CityCanvas").then((module) => ({ default: module.CityCanvas })));
  ...
  return (
    <main className="welcome-screen">
      ...
      <div className="welcome-scene" aria-hidden="true">
        <Suspense fallback={<span className="welcome-city-loading" />}><CityCanvas points={0} fallback="empty" /></Suspense>
      </div>
